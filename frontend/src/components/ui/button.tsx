  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive/10 text-red-400 border border-red-600/40 hover:bg-destructive/20",
        outline:
        ...
        success:
          "bg-green-900/40 text-green-300 border border-green-600/40 hover:bg-green-900/60",
        warning:
          "bg-amber-900/40 text-amber-300 border border-amber-600/40 hover:bg-amber-900/60",
      },
      size: {
